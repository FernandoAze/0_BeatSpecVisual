...
example3_BeatOutput.turn_to_SVG(  
                                    filename            = str(root_dir / input_parent_dir / "Performance3/BeatOutput LAYER.svg"), 
                                    svg_warped_score    = svg_score_example3,
                                    print_output        = False)
example3_BeatOutput.combine_layers_with_score( 
                                ...
                                layers_svg      = str(root_dir / input_parent_dir / "Performance3/BeatOutput LAYER.svg"),
                                maps_file       = maps_file_example3,
                                print_output    = False)

print("==================" + "BeatThis Probability Layer" + "==================")
...
example3_BeatProbOutput.turn_to_SVG(  
...
example3_BeatOutput.combine_layers_with_score( 
                                ...
                                original_score  = svg_score_example3, 
                                PNG_layer       = spec_example3,
                                layers_svg      = str(root_dir / input_parent_dir / "Performance3/BeatPROB LAYER.svg"),
                                maps_file       = maps_file_example3,
                                print_output    = False)
...
svg_layers_to_combine = [
    (str(root_dir / input_parent_dir / "Performance3/example3 Beat.svg"), 50),
    (str(root_dir / input_parent_dir / "Performance3/example3 PROBS.svg"), 225)
]
