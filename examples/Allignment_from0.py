...
#                                 downbeat_color  =(0, 1, 0)))   # Green downbeats
...
# malandro=viz.TurnLayersIntoSVG(  filename    = str(root_dir / input_parent_dir / "LAYERS.svg"), 
...
#5th Combine Layers
# WS.extract_viewBox_dimensions(svg_score, print_output=True)
WS.combine_AllignedScore_with_Layers(filename        = str(root_dir / input_parent_dir / "FINAL_SVG.svg"), 
                                    ...
                                    scale_factor    = WS.scale_Factor(svg_score, print_output=True),
                                    print_output    = stuff_to_console)
