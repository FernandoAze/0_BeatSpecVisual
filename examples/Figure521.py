...
chroma_layer.add_layer(Chromagram(color_map="cool"))
...
svg_layers_to_stack = [
    #Top Layer with score, spectrogram and onsets
    (str(tmp_dir / "SPECTROGRAM.png"), 10),
    (str(tmp_dir / "Onset_Layer.svg"), 10),
    (svg_score, 10),
    #Middle Layer with chromagram and onsets
    (str(tmp_dir / "Chroma_Layer.png"), Layer_Height + (2*10)),
    (str(tmp_dir / "Onset_Layer.svg"), Layer_Height + (2*10)),
    #Bottom Layer with waveform and onsets
    (str(tmp_dir / "Waveform_Layer_wScore.svg"), Layer_Height*2 + (3*10)),
